...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_notuning/exp_satellite_xgboost.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_notuning/exp_outdoor_xgboost.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_notuning/exp_all_xgboost.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_notuning/inc_satellite_xgboost.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_notuning/inc_outdoor_xgboost.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_notuning/inc_all_xgboost.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_notuning/assets_satellite_xgboost.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_notuning/assets_outdoor_xgboost.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_notuning/assets_all_xgboost.pkl')
...
train_res.to_csv('output/supervised_notuning/train_results_xgboost.csv', index = False)

test_res = testdf.loc[: , ['household',
                 'exp_true', 'exp_sat', 'exp_outdoor', 'exp_all',
                 'inc_true', 'inc_sat', 'inc_outdoor', 'inc_all',
                 'assets_true', 'assets_sat', 'assets_outdoor', 'assets_all']]
test_res.to_csv('output/supervised_notuning/test_results_xgboost.csv', index = False)
