...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/exp_reduced_rf.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/inc_reduced_rf.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/assets_reduced_rf.pkl')
...
train_res.to_csv('output/supervised_tuning/train_results_reduced.csv', index = False)

test_res = testdf.loc[: , ['household',
                 'exp_true', 'exp_red', 
                 'inc_true', 'inc_red', 
                 'assets_true', 'assets_red']]
test_res.to_csv('output/supervised_tuning/test_results_reduced.csv', index = False)
