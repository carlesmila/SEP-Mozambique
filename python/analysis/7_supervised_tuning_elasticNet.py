...
Fine-tuned features, elasticNet
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/exp_satellite_elasticNet.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/exp_outdoor_elasticNet.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/exp_all_elasticNet.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/inc_satellite_elasticNet.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/inc_outdoor_elasticNet.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/inc_all_elasticNet.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/assets_satellite_elasticNet.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/assets_outdoor_elasticNet.pkl')
...
# Write model
joblib.dump(pipe_fit.best_estimator_, 'output/supervised_tuning/assets_all_elasticNet.pkl')
...
train_res.to_csv('output/supervised_tuning/train_results_elasticNet.csv', index = False)

test_res = testdf.loc[: , ['household',
                 'exp_true', 'exp_sat', 'exp_outdoor', 'exp_all',
                 'inc_true', 'inc_sat', 'inc_outdoor', 'inc_all',
                 'assets_true', 'assets_sat', 'assets_outdoor', 'assets_all']]
test_res.to_csv('output/supervised_tuning/test_results_elasticNet.csv', index = False)
