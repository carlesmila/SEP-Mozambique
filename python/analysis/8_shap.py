...
imputer = joblib.load('output/supervised_tuning/assets_all_rf.pkl')['imputer']
model = joblib.load('output/supervised_tuning/assets_all_rf.pkl')['regressor']
...
# Read model and prep explainer
imputer = joblib.load('output/supervised_tuning/exp_all_rf.pkl')['imputer']
model = joblib.load('output/supervised_tuning/exp_all_rf.pkl')['regressor']
explainer = shap.TreeExplainer(model)
...
# Read model and prep explainer
imputer = joblib.load('output/supervised_tuning/inc_all_rf.pkl')['imputer']
model = joblib.load('output/supervised_tuning/inc_all_rf.pkl')['regressor']
explainer = shap.TreeExplainer(model)
