...
photopaths = photopaths[['household', 'foto1']] 
...
traindf = traindf[['household', 'foto1', 'exp_cat2', 'inc_cat2', 'assets_cat2']]
testdf = datadf.loc[datadf['split']=='test']
testdf = testdf[['household', 'foto1', 'exp_cat2', 'inc_cat2', 'assets_cat2']]
del(datadf)
...
torch.save(model.state_dict(), 'output/finetuning/foto1_weights.pth')
epoch_record.to_csv('output/finetuning/foto1_record.csv', index = False)
