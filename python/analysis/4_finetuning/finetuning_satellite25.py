...
photopaths = photopaths[['household', 'satellite25']] 
...
traindf = traindf[['household', 'satellite25', 'exp_cat2', 'inc_cat2', 'assets_cat2']]
testdf = datadf.loc[datadf['split']=='test']
testdf = testdf[['household', 'satellite25', 'exp_cat2', 'inc_cat2', 'assets_cat2']]
del(datadf)
...
torch.save(model.state_dict(), 'output/finetuning/satellite25_weights.pth')
epoch_record.to_csv('output/finetuning/satellite25_record.csv', index = False)
