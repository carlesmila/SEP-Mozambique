...
photopaths = photopaths[['household', 'satellite100']] 
...
traindf = traindf[['household', 'satellite100', 'exp_cat2', 'inc_cat2', 'assets_cat2']]
testdf = datadf.loc[datadf['split']=='test']
testdf = testdf[['household', 'satellite100', 'exp_cat2', 'inc_cat2', 'assets_cat2']]
del(datadf)
...
torch.save(model.state_dict(), 'output/finetuning/satellite100_weights.pth')
epoch_record.to_csv('output/finetuning/satellite100_record.csv', index = False)
